...
* Prevalent cases of dementia and/or Alzheimer's disease
  ...
  * n = 388 such prevalent cases were excluded, resulting n = 39,761 subjects
...
* Unverified dates of deaths
  ...
  * There were 21 unverified death dates. Excluding these resulted n = 39,740.

* Missing values in covariates
  * There were n = 3370 subjects who has at least one missing value on covariates (such as marital status, education, exercise level, sleep hours, smoking and alcohol use, all of them come from AHS questionnaire). These subjects were excluded, resulting in n = 36,370.
