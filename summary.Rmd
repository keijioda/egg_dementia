...
* Medicare beneficiaries who did not reach the age of 65 between 2008 and 2020 (e.g., younger beneficiaries with disabilities or end-stage renal disease) were excluded (n = 1336), resulting n = 39,763.

* n = 82 subjects with extreme BMI (<16 or >60), according to AHS questionnaire, were excluded, resulting n = 39,681.
...
* Prevalent cases of dementia and/or Alzheimer's disease
  ...
  * n = 377 such prevalent cases were excluded, resulting n = 39,304 subjects
...
* Unverified dates of deaths
  ...
  * There were 19 unverified death dates. Excluding these resulted n = 39,285.
...
* Frequency of egg intake was compared between the baseline questionnaire and HHF version 6
  ...
  * Among our analytic sample, there are n = 23,843 subjects (60.7%) who returned HHF6 questionnaire
  * After excluding n = 741 invalid responses on egg frequency, there were n = 23,102 in the crosstab below
