...
* Combine semi- and non-vegetarians into one group and make this as reference

* Run the following models:
  * MV1 + egg (retain dietary groups)
  * Separate meat into two food group variables, beef and poultry, while excluding pork from the model
