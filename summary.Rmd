...
* For each those dietary variables that indicate a non-linear association, a plot of adjusted hazard ratio was produced to visualize how HR changes over a range of intake. 
  * For eggs, an intake of 10 gram/day was chosen to be its reference value of the HR plot.
  * Total vegetable intake was another dietary variable showing a significant non-linearity. Its reference value was set to 300 gram/day.
...
* Tables below shows adjusted HR for some representative values of vegetable gram intake (reference = 300 gram/day).

```{r cubic_spline_HR_veg, echo = FALSE, , warning = FALSE, message = FALSE}
