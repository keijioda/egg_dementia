...
* The descriptive table by case/non-case:
  ...
  * Other demographic and lifestyle variables were derived from AHS-2 baseline questionnaire
    ...
    * Sleep hours
  * Comorbidity variables (yes/no) were derived from Medicare chronic condition data. Those who were diagnosed with the following conditions prior to dementia/Alzheimer's disease were flagged.
