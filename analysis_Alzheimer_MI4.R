...
MI4_mv1a_trend <- list(update(mv1a_mod, .~. - educyou2 + as.numeric(educyou)),
...
MI4_mv2a_trend <- list(update(mv2a_mod, .~. - educyou2 + as.numeric(educyou)),
...
MI4_mv2c_trend <- list(update(mv2c_mod, .~. - educyou2 + as.numeric(educyou)),
